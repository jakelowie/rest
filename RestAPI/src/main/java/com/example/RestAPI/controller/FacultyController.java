...
public class FacultyController {
    ...
    public Response updateFaculty(@RequestBody Faculty faculty) {
        logger.info("Update with values {}, {}, {}, {}, {}", faculty.getFaculty_id(),faculty.getFaculty_name(), faculty.getFaculty_email(), faculty.getFaculty_phone_number(), faculty.getFaculty_address());
