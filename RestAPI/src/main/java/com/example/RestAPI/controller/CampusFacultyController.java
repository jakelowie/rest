...
public class CampusFacultyController {
    ...
    @RequestMapping(value = "lookup/unassigned/faculties", method = RequestMethod.GET)
    @ResponseBody
    @CrossOrigin(origins = "*")
    public Response lookFacultiesNotInCampus(@RequestParam long campus_id) {
        return campusFacultyService.lookFacultiesNotInCampus(campus_id);
    }
